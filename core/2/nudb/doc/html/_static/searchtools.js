...
const splitChars = (function () {
  const result = {}
  const singles = [96, 180, 187, 191, 215, 247, 749, 885, 903, 907, 909, 930, 1014, 1648,
  ...
  const ranges = [[0, 47], [58, 64], [91, 94], [123, 169], [171, 177], [182, 184], [706, 709],
...
var Search = {
  ...
  query: function (query) {
    let i
    const stopwords = ['a', 'and', 'are', 'as', 'at', 'be', 'but', 'by', 'for', 'if', 'in', 'into', 'is', 'it', 'near', 'no', 'not', 'of', 'on', 'or', 'such', 'that', 'the', 'their', 'then', 'there', 'these', 'they', 'this', 'to', 'was', 'will', 'with']
  ...
  performTermsSearch: function (searchterms, excluded, terms, titleterms) {
    ...
    for (file in fileMap) {
      ...
      if (valid) {
        ...
        const score = $u.max($u.map(fileMap[file], function (w) { return scoreMap[file][w] }))
