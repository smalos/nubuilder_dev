...
AJAX.registerOnload('import.js', function () {
  ...
  $(document).on('submit', '#import_file_form', function () {
    ...
    const fileMsg = '<div class="alert alert-danger" role="alert"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_error"> ' + Messages.strImportDialogMessage + '</div>'
    const wrongTblNameMsg = '<div class="alert alert-danger" role="alert"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_error">' + Messages.strTableNameDialogMessage + '</div>'
    const wrongDBNameMsg = '<div class="alert alert-danger" role="alert"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_error">' + Messages.strDBNameDialogMessage + '</div>'
    ...
    if (radioLocalImport.length !== 0) {
      ...
      if ($('#text_csv_new_tbl_name').length > 0) {
        const newTblName = $('#text_csv_new_tbl_name').val()
      ...
      if ($('#text_csv_new_db_name').length > 0) {
        const newDBName = $('#text_csv_new_db_name').val()
