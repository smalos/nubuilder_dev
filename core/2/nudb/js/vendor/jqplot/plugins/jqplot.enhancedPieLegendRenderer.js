...
(function ($) {
  ...
  $.jqplot.EnhancedPieLegendRenderer.prototype.draw = function (offsets, plot) {
    ...
    if (this.show) {
      ...
      let i, j, tr, td1, td2, lt, rs, div, div0, div1
      let idx = 0
            ...
            if (lt) {
              ...
              if (this.seriesToggle) {
                ...
                if (this.showSwatches) {
                  td1.bind('click', { series: s, index: idx, speed, plot, replot: this.seriesToggleReplot }, handleToggle)
                  td1.addClass('jqplot-seriesToggle')
                }
                if (this.showLabels) {
                  td2.bind('click', { series: s, index: idx, speed, plot, replot: this.seriesToggleReplot }, handleToggle)
  ...
  var handleToggle = function (ev) {
    const d = ev.data
    const replot = d.replot
    const plot = d.plot
    const idx = d.index

    d.series.showSlice[idx] = (d.series.showSlice[idx] === false)
  ...
  var postDraw = function () {
    if (this.legend.renderer.constructor == $.jqplot.EnhancedPieLegendRenderer && this.legend.seriesToggle) {
      const e = this.legend._elem.detach()
