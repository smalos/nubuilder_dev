...
this.zxcvbnts.core = (function (exports) {
  ...
  const repeatMatcher$1 = ({
    baseGuesses,
    repeatCount
  }) => baseGuesses * repeatCount

  const sequenceMatcher$1 = ({
    token,
    ascending
  }) => {
  ...
  const estimateGuesses = (match, password) => {
  ...
  const dictionaryMatcher = (match, isSoleMatch) => {
