...
function nuShowFormInfo () {
  ...
  const browseSQL = nuFormType() == 'browse' && (!code.startsWith('nu') || devMode) ? '<b>Browse SQL:</b></br> ' + cp.browse_sql : ''
...
function nuAddIconToBreadcrumbHolder (i, title, oClick, iClass, paddingLeft) {
  const h = "<div id='" + i + "' title='" + title + "' style='font-size: 16px; display: inline-block; cursor : pointer; padding-right:8px; padding-left:" + paddingLeft + "' onclick='" + oClick + "'><i class='" + iClass + "'></i>&nbsp;" + '' + '</div>'
