...
function nuSetObjectBounds (obj, top = null, left = null, width = null, height = null, absolute = null) {
  if (top !== null) { obj.css('top', Number(top)) }
  if (left !== null) { obj.css('left', Number(left)) }
  if (height !== null) { obj.css('height', Number(height)) }
  if (width !== null) { obj.css('width', Number(width)) }
  if (!absolute) { obj.css('position', 'absolute') }
