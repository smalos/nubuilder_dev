...
function nuRemoveBox (ctrlKey) {
  ...
  const L			= parseInt(selectBox.css('left'))
  const T			= parseInt(selectBox.css('top')) - nuGetTopArea()
  const B			= T + parseInt(selectBox.css('height'))
  const R			= L + parseInt(selectBox.css('width'))
