...
function nuUpdateGroup (t) {
  const g = $('#' + t.id).attr('data-group')
  const G = nuREPORT.groups[g]
  const s = nuREPORT.groups[g].sections.length
